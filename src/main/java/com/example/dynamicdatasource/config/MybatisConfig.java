...
@Configuration
@MapperScan(basePackages = {"com.example.dynamicdatasource.dao"}) // 扫描DAO
public class MybatisConfig {
    ...
    public DataSource dynamicDataSource() {
        ...
        dataSourceMap.put(DataSourceType.master.getDb(), master());
        dataSourceMap.put(DataSourceType.slave.getDb(), slave());
    ...
    public SqlSessionFactoryBean sqlSessionFactoryBean() throws Exception {
        ...
        sessionFactory.setTypeAliasesPackage("com.example.dynamicdatasource.model");    // 扫描Model
